 ...
 * instantiation of VLCLibrary, as previously noted, this is done automatically by the dynamic link loader.
 */
 ...
 * \note set level from 0 (all) to 4 (just error messages)
